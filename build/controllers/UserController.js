...
exports.resetPassword = exports.verifyEmail = exports.deleteUser = exports.abc = exports.getAllUserType = exports.getUpdateModel = exports.getCreateModel = exports.updateUser = exports.registerUser = exports.getAllUsersPaged = exports.getAllUsers = exports.getSingleUser = void 0;
...
const UserType_1 = require("../data/Entity/UserType");
...
const updateUser = async (req, res) => {
    ...
    try {
        ...
        const updatedUser = await (0, UserDAL_1.UserUpdate)(idUser, userData);
        return res.status(200).send({
            status: 200,
...
const getAllUserType = async (req, res) => {
    const userType = await (0, UserTypeDAL_1.UserTypeGetAll)();
...
const verifyEmail = async (req, res) => {
    ...
    try {
        ...
        if (existingUser) {
            ...
            const passwordResetLink = `https://admin.koscatrecycler.com/reset-password/${token}/${existingUser.idUser}`;
            // const passwordResetLink = `http://localhost:3000/reset-password/${token}/${existingUser.idUser}`;
            const mailOptions = {
                from: '"Koscat Recycler" <koscatrecycler@koscatrecycler.com>',
                ...
                html: `
                    ...
                    <body style="background-color: #e9e7e7; display: flex; justify-content: center; font-family: Arial, Helvetica, sans-serif;">
                        <div style="width: 50%;">
                            <div style="text-align: center; padding: 20px;">
                                <img src="https://admin.koscatrecycler.com/assets/Lockup-Color.svg" alt="logo" style="width: 200px;">
                            </div>
                            <div style="background-color: white; padding: 30px; color: #3d4852;">
                                ...
                                <div style="text-align: center; padding-top: 17px;">
                                    <a href="${passwordResetLink}" style="padding: 10px 20px; color: white; background-color: #014830; text-decoration: none; border-radius: 6px;">Kliko këtu</a>
                                </div>
                            </div>
                        </div>
                    </body>
