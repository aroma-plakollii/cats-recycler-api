...
export const updateUser = async (req: any, res: any) => {
    ...
    try {
        ...
        const updatedUser = await UserUpdate(idUser, userData);
...
export const getAllUserType = async (req: Request, res: Response) => {
    const userType = await UserTypeGetAll();
...
export const verifyEmail = async (req: any, res: any) => {
    ...
    try{
        ...
        if(existingUser){
            ...
            const mailOptions = {
                from: '"Koscat Recycler" <koscatrecycler@koscatrecycler.com>', // Make sure the sender address is correctly formatted
